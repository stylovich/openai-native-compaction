...
export OPENCODE_NATIVE_COMPACTION_SUMMARY_MODEL="${OPENCODE_NATIVE_COMPACTION_SUMMARY_MODEL:-gpt-5.4}"
...
```bash
export OPENCODE_NATIVE_COMPACTION_MODEL="gpt-5.4"
export OPENCODE_NATIVE_COMPACTION_SUMMARY_MODEL="gpt-5.4"
